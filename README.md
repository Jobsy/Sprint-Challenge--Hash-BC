...
A dynamic array is an array that automatic resizing. That is, it expands as you add more elements, So you don't need to determine the size ahead of time.
...
add or remove from the back: 0(1) if there is space; otherwise if I am adding if the space is full it is 0(n)

- What is the worse case scenario if you try to extend the storage size of a dynamic array?
  worse case scenario: 0(n)
...
Proof of Work is an arbitrarily difficult problem to solve
